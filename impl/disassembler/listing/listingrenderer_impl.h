...
class ListingRendererImpl
{
    ...
    public:
        ...
        void renderSymbolPrologue(const document_s_lock &lock, const ListingItem& item, const Symbol *symbol, RendererLine& rl) const;
        void renderBlockBytes(const BlockItem* bi, RendererLine& rl) const;
        bool getRendererLine(const document_s_lock& lock, size_t line, RendererLine& rl) const;
    ...
    private:
        void renderPrologue(const document_s_lock &lock, const ListingItem& item, RendererLine& rl) const;
