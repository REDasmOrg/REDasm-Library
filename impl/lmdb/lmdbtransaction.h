...
class LMDBTransaction
{
    ...
    public: // Put
        void puts(const String& key, const String& val);
        template<typename T> void put(const String& key, const T& val);
    ...
    public: // Get
        ...
        template<typename T> const T* get(const String& k) const;
        template<typename T, typename K> void get(const K& key, T* t) const;
        template<typename T> void get(const String& key, T* t) const;
...
template<typename T>
void LMDBTransaction::get(const String& key, T* t) const
{
    T* res = nullptr;
...
template<typename T>
void LMDBTransaction::put(const String& key, const T& val)
{
...
template<typename T>
const T* LMDBTransaction::get(const String& k) const
{
    T* t = nullptr;
