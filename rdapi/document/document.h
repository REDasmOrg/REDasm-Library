...
RD_API_EXPORT void RDDocument_AddSegmentSize(RDDocument* d, const char* name, offset_t offset, address_t address, u64 psize, u64 vsize, flag_t flags);
RD_API_EXPORT void RDDocument_AddSegment(RDDocument* d, const char* name, offset_t offset, address_t address, u64 size, flag_t flags);
