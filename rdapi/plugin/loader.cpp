...
void RDLoader_Build(RDLoader* ldr, const RDLoaderBuildRequest* req) { return CPTR(Loader, ldr)->build(req); }
void RDLoader_Load(RDLoader* ldr) { return CPTR(Loader, ldr)->load(); }
