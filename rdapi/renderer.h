...
RD_API_EXPORT const char* RDRenderer_GetAssemblerInstruction(const RDRenderer* r, rd_address address);
RD_API_EXPORT const char* RDRenderer_GetRDILInstruction(const RDRenderer* r, rd_address address);
