...
RD_API_EXPORT RDSurfacePos RDSurface_GetPosition(const RDSurface* sf);
RD_API_EXPORT RDSurfacePos RDSurface_GetSelection(const RDSurface* sf);
RD_API_EXPORT RDSurfacePos RDSurface_GetStartSelection(const RDSurface* sf);
RD_API_EXPORT RDSurfacePos RDSurface_GetEndSelection(const RDSurface* sf);
...
RD_API_EXPORT void RDSurface_Scroll(RDSurface* sf, int nx, int ny);
