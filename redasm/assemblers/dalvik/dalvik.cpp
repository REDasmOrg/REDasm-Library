...
u32 DalvikAssembler::bits() const { return 32; }
...
bool DalvikAssembler::decode00(BufferView& view, const InstructionPtr &instruction) { return decodeOp0(view, instruction, "nop", DalvikOpcodes::Nop, InstructionTypes::Nop); }
