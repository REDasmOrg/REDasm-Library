...
flag_t Loader::flags() const { return Loader::None; }
...
const ListingDocument &Loader::document() const { PIMPL_P(const Loader); return p->documentNew(); }
ListingDocument &Loader::document() { PIMPL_P(Loader); return p->documentNew(); }
