...
const PluginManager::Plugins &PluginManager::activePlugins() const { PIMPL_P(const PluginManager); return p->m_activeplugins; }
...
PluginManager::PluginsList PluginManager::getLoaders(const LoadRequest* request)
{
    PIMPL_P(PluginManager);
    PluginsList plugins;
