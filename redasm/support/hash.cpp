...
u16 Hash::crc16(const String &s) { return Hash::crc16(reinterpret_cast<const u8*>(s.c_str()), s.size()); }
...
u32 Hash::crc32(const String &s) { return Hash::crc32(reinterpret_cast<const u8*>(s.c_str()), s.size()); }
