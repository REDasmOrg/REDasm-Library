...
void Set::erase(const Variant &v) { PIMPL_P(Set); p->remove(v); }
...
void Set::eraseAt(size_t idx) { PIMPL_P(Set); return p->remove(idx); }
...
void SortedSet::erase(const Variant &v) { PIMPL_P(SortedSet); p->remove(v); }
...
void SortedSet::eraseAt(size_t idx) { PIMPL_P(SortedSet); return p->remove(idx); }
